...
public class RegisterRequestValidator : AbstractValidator<RegisterRequest>
{
    public RegisterRequestValidator()
    {
        ...
        RuleFor(x => x.Roles)
            ...
            .Must(roles => roles.All(role => 
                role is "Admin" or "Receptionist" or "Technician" or "LabManager"))
            .WithMessage("Roles must be one of: Admin, Receptionist, Technician, LabManager");
    }
}

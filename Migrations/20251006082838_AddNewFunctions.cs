...
{
    /// <inheritdoc />
    public partial class AddNewFunctions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Applicability = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    SpecificTestId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    SpecificPackageId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    MinimumTests = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InsuranceClaims_Users_SubmittedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PaymentPlans_Users_CreatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TestOrderId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Type = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Status = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ...
                    VolumeUnit = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    ProcessedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventoryAlerts_Users_ResolvedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PaymentPlanInstallments_Payments_PaymentId",
                        column: x => x.PaymentId,
                        principalTable: "Payments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SampleTrackings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SampleTrackings_Samples_SampleId",
                        column: x => x.SampleId,
                        principalTable: "Samples",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SampleTrackings_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TestsRemaining = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PackageSubscriptions_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PackageSubscriptions_TestPackages_TestPackageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TestPackageItems_LabTests_LabTestId",
                        column: x => x.LabTestId,
                        principalTable: "LabTests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TestPackageItems_TestPackages_TestPackageId",
                        column: x => x.TestPackageId,
                        principalTable: "TestPackages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantityReceived = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    UnitPrice = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InsuranceClaims_SubmittedByUserId",
                table: "InsuranceClaims",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryAlerts_ResolvedByUserId",
                table: "InventoryAlerts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PackageSubscriptions_PatientId",
                table: "PackageSubscriptions",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_PackageSubscriptions_TestPackageId",
                table: "PackageSubscriptions",
                column: "TestPackageId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentPlanInstallments_PaymentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SampleTrackings_SampleId",
                table: "SampleTrackings",
                column: "SampleId");

            migrationBuilder.CreateIndex(
                name: "IX_SampleTrackings_UserId",
                table: "SampleTrackings",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TestPackageItems_LabTestId",
                table: "TestPackageItems",
                column: "LabTestId");

            migrationBuilder.CreateIndex(
                name: "IX_TestPackageItems_TestPackageId",
                table: "TestPackageItems",
                column: "TestPackageId");
        }
